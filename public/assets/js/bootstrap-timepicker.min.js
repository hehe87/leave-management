  ...
  Timepicker.prototype = {
    ...
    decrementHour: function() {
		...
		if(elementVal != ""){
			...
			var arrElementVal = elementVal.split(":");
			mhour = arrElementVal[0];
			mmin = arrElementVal[1].split(" ")[0];
			if (this.showMeridian) {
				mmeridian = arrElementVal[1].split(" ")[1];
				this.meridian = mmeridian;
			}
			this.hour = parseInt(mhour);
			this.minute = parseInt(mmin);
		}
      if (this.showMeridian) {
        if (this.hour === 1) {
          this.hour = 12;
